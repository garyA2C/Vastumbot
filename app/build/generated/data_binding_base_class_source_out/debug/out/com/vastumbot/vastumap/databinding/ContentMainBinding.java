...
public final class ContentMainBinding implements ViewBinding {
  ...
  private ContentMainBinding(@NonNull ConstraintLayout rootView, @NonNull Switch swi) {
  ...
  public static ContentMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.swi;
      Switch swi = ViewBindings.findChildViewById(rootView, id);
      if (swi == null) {
        break missingId;
      }

      return new ContentMainBinding((ConstraintLayout) rootView, swi);
    }
